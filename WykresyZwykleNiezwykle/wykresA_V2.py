def create_chart(a, c):
    ...
    chart_lines = [
        ...
        space * (max_width - a - 2) + vertical_bar + space * a + vertical_bar + space * (max_width - a - 2),
        space * (max_width - a - 2) + top_bar + space * (max_width - a - 2),
        space * (max_width - 1) + vertical_bar,
        space * (max_width - b - 2) + mid_bar + space * (max_width - b - 2),
        space * (max_width - b - 2) + vertical_bar + space * b + vertical_bar + space * ((max_width - b - 2) // 2),
        space * (max_width - b - 2) + mid_bar + space * ((max_width - b - 2) // 2),
        space * (max_width - 1) + vertical_bar,
        space * (max_width - c - 2) + bot_bar + space * ((max_width - c - 2) // 2),
        space * (max_width - c - 2) + vertical_bar + space * c + vertical_bar + space * ((max_width - c - 2) // 2),
        space * (max_width - c - 2) + bot_bar + space * ((max_width - c - 2) // 2),
        space * (max_width - 1) + vertical_bar
    ]
